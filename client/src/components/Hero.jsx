      ...
      <div className="container mx-auto px-8 lg:flex">
        <div className="text-center lg:text-left lg:w-1/2">
          ...
          <p className="text-xl lg:text-2xl mt-6 font-light">
            ...
            doloremque quo, nihil dolorem corporis quasi suscipit a dolorum.
            Deleniti iure voluptatum cumque unde labore?
          </p>
          <div className="flex flex-row mt-8 md:mt-12 gap-4">
            <Link to={"/search?searchTerm="}>
              <Button theme={customButtonTheme} color="failure" type="button">
                Read More
              </Button>
            </Link>
            <Link to={currentUser ? "/" : "/sign-up"}>
              <Button theme={customButtonTheme} color="signup" type="button">
                Sign Up
              </Button>
            </Link>
          </div>
